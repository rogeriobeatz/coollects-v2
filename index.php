...
<head>
    ...
    <title>Coollects - App para colecionadores</title>
...
<div class="container home-login">
    <div id="lottie-player">
        <lottie-player id="" src="assets/intro-anim.json" background="transparent"  speed="1"  style="width: var(--viewport); max-height: 240px;" autoplay ></lottie-player> 
    </div>
...
<?php 
        ...
        switch(@$_REQUEST["page"]){
                case 'login':
                include("acesso/login.php");
                break;
                case "novo":
                include("acesso/novo-usuario.php");
                break;
                case "salvar":
                include("acesso/salvar-usuario.php");
                break;
        }
    ?>
...
<script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            setTimeout(function () {
                lottiePlayer.style.transform = "translateY(-100%)";
                welcomeModal.style.opacity = "1";
                welcomeModal.style.transform = "translateY(-90%)";
            }, 3000);
        });
    </script>
</body>
